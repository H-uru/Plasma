...
void plParticleUpdateMsg::Read(hsStream* stream, hsResMgr* mgr)
{
...
void plParticleTransferMsg::Write(hsStream* stream, hsResMgr* mgr)
{
    plMessage::IMsgWrite(stream, mgr);
...
void plParticleKillMsg::Read(hsStream* stream, hsResMgr* mgr)
{
    plMessage::IMsgRead(stream, mgr);
