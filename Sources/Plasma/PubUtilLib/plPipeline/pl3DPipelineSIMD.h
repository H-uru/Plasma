...
*==LICENSE==*/
#ifndef _pl3DPipelineSIMD_inc_
#define _pl3DPipelineSIMD_inc_
...
hsCpuFunctionDispatcher<typename pl3DPipeline<DeviceType>::blend_vert_buffer_ptr> pl3DPipeline<DeviceType>::fBlendVertBuffer {
