...
public:
    ...
    void AddContact(plPXPhysical* phys, const hsPoint3& pos, hsVector3 normal);

    /** Allows modification of contacts with this character as detected by the simulation. */
    void ModifyContacts(plPXPhysical* phys, physx::PxContactSet& contacts) const;
