...
public:
    ...
    void            ReadLE(int* value) { *value = (Int32)this->ReadLE32(); }
    void            ReadLE(int count, int values[]) { this->ReadLE32(count, (UInt32*)values); }
#ifdef STREAM_LOGGER
                // Begin LogReadLEs
    ...
    void            WriteLE(int value) { this->WriteLE32((UInt32)value); }
    void            WriteLE(int count, const  int values[]) { this->WriteLE32(count, (UInt32*)values); }
    /* Overloaded  End */
