...
{
    //this is supposed to prevent the dock from showing in full screen mode, but it does not always work. FB9988268
    //other games have the same issue and have really ugly workarounds
