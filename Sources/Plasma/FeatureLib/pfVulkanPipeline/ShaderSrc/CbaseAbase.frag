...
// Ported from ps_CbaseAbase (WaveDec1Lay_7.metal:233-246). Base color, base
// alpha: the plainest of the ps_C*A* family, and the only one Metal implements.
...
void main()
{
    outColor = texture(sampler2D(textures2D[0], samplers[0]), inTexCoord) * inColor;
}
