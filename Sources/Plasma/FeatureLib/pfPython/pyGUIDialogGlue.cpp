...
PYTHON_START_METHODS_TABLE(ptGUIDialog)
    ...
    PYTHON_METHOD(ptGUIDialog, getControlModFromIndex, "Type: (index: int) -> ptGUIControl\nReturns the ptGUIControl with the specified index (not tag ID!)"),
    ...
    PYTHON_METHOD(ptGUIDialog, getControlModFromTag, "Type: (tagID: int) -> ptGUIControl\nReturns the ptGUIControl with the specified tag ID"),
