...
void PythonInterface::initPyPackHook()
{
    ...
    ptModulePackFinder* metaFinder = (ptModulePackFinder*)pyModulePackFinder::New();
    metaFinder->fThis->fLoader = pyModulePackLoader::New();
    ...
    PyList_Append(finders, (PyObject*)metaFinder);
}
