...
private:
    ...
    enum func_num
    {
        kfunc_OnFirstUpdate = 0,
        kfunc_OnUpdate,
        kfunc_OnNotify,
        kfunc_OnTimer,
        kfunc_OnControlKeyEvent,
        kfunc_Load,
        kfunc_OnGUINotify,
        kfunc_OnPageLoad,
        kfunc_OnClothingUpdate,
        kfunc_OnKIMsg,
        kfunc_OnMemberUpdate,
        kfunc_OnRemoteAvatarInfo,
        kfunc_OnRTChat,
        kfunc_OnVaultEvent,
        kfunc_AvatarPage,
        kfunc_OnSDLNotify,
        kfunc_OnOwnershipChanged,
        kfunc_OnAgeVaultEvent,
        kfunc_OnInit,
        kfunc_OnCCRMsg,
        ...
        kfunc_OnLOSNotify,
        kfunc_BeginAgeUnLoad,
        kfunc_OnMovieEvent,
        kfunc_OnScreenCaptureDone,
        kfunc_OnClimbingBlockerEvent,
        kfunc_OnAvatarSpawn,
