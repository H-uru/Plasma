...
PYTHON_START_METHODS_TABLE(ptAudioControl)
    ...
    PYTHON_BASIC_METHOD(ptAudioControl, enableSubtitles, "Enables subtitles for audio."),
    PYTHON_BASIC_METHOD(ptAudioControl, disableSubtitles, "Disables subtitles for audio."),
    PYTHON_METHOD_NOARGS(ptAudioControl, areSubtitlesEnabled, "Are subtitles for the audio enabled? Returns 1 if true otherwise returns 0."),
