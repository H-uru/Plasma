...
public:
    ...
    pfBookData(const ST::string &guiName = ST::string::null);
    virtual ~pfBookData();
...
class pfJournalBook : public hsKeyedObject
{
    public:
        ...
        pfJournalBook( const char *esHTMLSource, plKey coverImageKey = nil, plKey callbackKey = nil, const plLocation &hintLoc = plLocation::kGlobalFixedLoc, const ST::string &guiName = ST::string::null );
        pfJournalBook( const wchar_t *esHTMLSource, plKey coverImageKey = nil, plKey callbackKey = nil, const plLocation &hintLoc = plLocation::kGlobalFixedLoc, const ST::string &guiName = ST::string::null );
