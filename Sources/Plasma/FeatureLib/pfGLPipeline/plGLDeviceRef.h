...
public:
    ...
    plGLVertexBufferRef*    GetNext() { return reinterpret_cast<plGLVertexBufferRef*>(fNext); }


    plGLVertexBufferRef()
        : plGLDeviceRef(), fCount(), fIndex(), fVertexSize(), fOffset(),
        fFormat(), fOwner(), fData(), fRefTime(), fVAO()
    { }
...
public:
    ...
    plGLIndexBufferRef* GetNext() { return reinterpret_cast<plGLIndexBufferRef*>(fNext); }
