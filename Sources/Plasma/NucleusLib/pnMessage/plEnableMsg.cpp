...
void plEnableMsg::Read(hsStream* stream, hsResMgr* mgr)
{
...
void plEnableMsg::Write(hsStream* stream, hsResMgr* mgr)
{
...
void plEnableMsg::ReadVersion(hsStream* stream, hsResMgr* mgr)
{
...
void plEnableMsg::WriteVersion(hsStream* stream, hsResMgr* mgr) 
{
