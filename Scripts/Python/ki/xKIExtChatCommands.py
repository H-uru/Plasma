...
xChatEmoteXlate = {
    ...
    Plasma.PtGetLocalizedString("KI.Commands.BeckonSmall"): (
        "BeckonSmall",
    ...
    Plasma.PtGetLocalizedString("KI.Commands.ShakeFist"): (
        "ShakeFist",
        "KI.EmoteStrings.ShakeFist",
    ),
    Plasma.PtGetLocalizedString("KI.Commands.Shoo"): ("Shoo", "KI.EmoteStrings.Shoo"),
    Plasma.PtGetLocalizedString("KI.Commands.SlouchSad"): (
        "SlouchSad",
    ...
    Plasma.PtGetLocalizedString("KI.Commands.ThumbsUp2"): (
        "ThumbsUp2",
