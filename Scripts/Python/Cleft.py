...
class Cleft(ptResponder):
    ...
    def OnServerInitComplete(self):
        ...
        if loadTomahna:
            ...
            if boolSceneBahro:
                PtDebugPrint(
                    "Cleft.OnServerInitComplete: SDL says bahro hasn't played yet, paging in SceneBahro stuff..."
                )
            ...
            if boolSceneYeesha:
                ...
                if boolOfficeDoor:
                    PtDebugPrint(
                        "Cleft.OnServerInitComplete: SDL says Yeesha will play and office door is shut, will open it"
                    )
    ...
    def Load(self):
        ...
        if boolKitchenDoor and boolOfficeDoor:
            ...
            PtDebugPrint(
                "Cleft.OnLoad: either Kitchen and/or Office door is already open... leaving Kitchen door alone"
            )
