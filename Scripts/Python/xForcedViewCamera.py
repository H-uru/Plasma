...
class xForcedViewCamera(ptModifier):
    ...
    def OnNotify(self, state, id, events):
        ...
        """
        PtDebugPrint("xForcedViewCamera.OnNotify  state=%f id=%d events=" % (state, id), events, level=kDebugDumpLevel)
    ...
    def OnGUINotify(self, id, control, event):
        ...
        """
        PtDebugPrint("xForcedViewCamera.OnGUINotify id=%d, event=%d control=" % (id, event), control, level=kDebugDumpLevel)
