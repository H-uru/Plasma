...
class clftWindmill(ptResponder):
    ...
    def OnServerInitComplete(self):
        ...
        try:
            ...
            windmillLocked = 1
            PtDebugPrint(
                "ERROR: clftWindmill.OnServerInitComplete():\tERROR: age sdl read failed, defaulting windmill locked"
            )
        if windmillLocked == 0:
        ...
        try:
            ...
            windmillRunning = 0
            PtDebugPrint(
                "ERROR: clftWindmill.OnServerInitComplete():\tERROR: age sdl read failed, defaulting windmill stopped"
            )
        if windmillRunning == 1:
            ...
            if boolTomahnaActive == 0:
                PtDebugPrint(
                    "clftWindmill.OnServerInitComplete: SDL says Tomahna is active, will set Imager light on..."
                )
        ...
        try:
            ...
            windmillUnstuck = 0
            PtDebugPrint(
                "ERROR: clftWindmill.OnServerInitComplete():\tERROR: age sdl read failed, defaulting windmill stuck"
            )
