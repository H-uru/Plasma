...
kRandomHairColors = [
    ptColor(0, 0, 0),
    ptColor(1, 1, 1),
    ptColor(0.46, 0.15, 0.15),
    ptColor(0.60, 0.25, 0.11),
    ptColor(0.48, 0.22, 0.12),
    ptColor(0.68, 0.37, 0.15),
    ptColor(0.98, 0.81, 0.58),
    ptColor(0.5, 0.5, 0.5),
]
kRandomSkinColors = [
    ptColor(0.94, 0.83, 0.64),
    ptColor(0.94, 0.77, 0.59),
    ptColor(0.88, 0.66, 0.49),
    ptColor(0.61, 0.41, 0.31),
...
def PtFindAvatar(events):
    ...
    for event in events:
        if (
            event[0] == kCollisionEvent
            or event[0] == kPickedEvent
            or event[0] == kFacingEvent
            or event[0] == kContainedEvent
            or event[0] == kSpawnedEvent
        ):
            return event[2]
